        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, headers_util_1.filterNullishValues(__assign(__assign({}, headers_util_1.getHeader('x-csrf-token', csrfHeaders)), { cookie: buildCookieHeaderValue(headers_util_1.getHeaderValue('set-cookie', csrfHeaders)) }))];
            }
        });
    });
}
...
function makeCsrfRequest(destination, requestConfig) {
    var fetchHeader = !headers_util_1.getHeaderValue('x-csrf-token', requestConfig.headers) && { 'x-csrf-token': 'Fetch' };
