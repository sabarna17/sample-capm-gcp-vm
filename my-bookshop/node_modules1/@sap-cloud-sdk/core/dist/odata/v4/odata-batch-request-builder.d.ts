...
import { ODataBatchChangeSetV4 } from './odata-batch-change-set';
 ...
 *
 */
export declare class ODataBatchRequestBuilderV4 extends MethodRequestBuilderBase<ODataBatchRequestConfig> {
    readonly defaultServicePath: string;
    readonly requests: (ODataBatchChangeSetV4<CreateRequestBuilderV4<EntityV4> | UpdateRequestBuilderV4<EntityV4> | DeleteRequestBuilderV4<EntityV4>> | GetAllRequestBuilderV4<EntityV4> | GetByKeyRequestBuilderV4<EntityV4>)[];
     ...
     */
    constructor(defaultServicePath: string, requests: (ODataBatchChangeSetV4<CreateRequestBuilderV4<EntityV4> | UpdateRequestBuilderV4<EntityV4> | DeleteRequestBuilderV4<EntityV4>> | GetAllRequestBuilderV4<EntityV4> | GetByKeyRequestBuilderV4<EntityV4>)[], entityToConstructorMap: Record<string, Constructable<EntityV4>>);
    /**
