import { Constructable, EntityIdentifiable, Filterable } from '../../common';
 ...
 */
export declare class GetAllRequestBuilderV2<EntityT extends EntityV2> extends GetAllRequestBuilderBase<EntityT> implements EntityIdentifiable<EntityT> {
    /**
