...
export declare class ODataBatchRequestBuilderV2 extends MethodRequestBuilderBase<ODataBatchRequestConfig> {
     ...
     */
    constructor(defaultServicePath: string, requests: (ODataBatchChangeSetV2<CreateRequestBuilderV2<EntityV2> | UpdateRequestBuilderV2<EntityV2> | DeleteRequestBuilderV2<EntityV2>> | GetAllRequestBuilderV2<EntityV2> | GetByKeyRequestBuilderV2<EntityV2>)[], entityToConstructorMap: Record<string, Constructable<EntityV2>>);
    /**
