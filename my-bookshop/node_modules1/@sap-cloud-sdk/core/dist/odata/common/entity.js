...
var EntityBase = /** @class */ (function () {
    function EntityBase() {
        util_1.nonEnumerable(this, '_oDataVersion');
    ...
    EntityBase.entityBuilder = function (entityConstructor) {
        ...
        entityConstructor._allFields.forEach(function (field) {
            var fieldName = "" + util_1.toPropertyFormat(field._fieldName);
    ...
    EntityBase.prototype.setOrInitializeRemoteState = function (state) {
        ...
        if (state) {
            Object.entries(state).forEach(function (_a) {
                ...
                if (_this[util_1.toPropertyFormat(fieldName)]) {
                    _this.remoteState[util_1.toPropertyFormat(fieldName)] = value;
                }
                else {
     ...
     */
    EntityBase.prototype.getCurrentMapKeys = function () {
        var _this = this;
    ...
    EntityBase.prototype.isConflictingCustomField = function (customFieldName) {
        return this[util_1.toPropertyFormat(customFieldName)] !== undefined;
    };
    return EntityBase;
}());
