...
var ODataRequest = /** @class */ (function () {
    ...
    ODataRequest.prototype.defaultHeaders = function () {
        var defaultHeaders = header_builder_1.replaceDuplicateKeys(header_builder_1.filterNullishValues({
            accept: 'application/json',
            'content-type': this.config.contentType
        }), this.customHeaders());
        return __assign(__assign(__assign({}, defaultHeaders), header_builder_1.getHeader('accept', this.customHeaders())), header_builder_1.getHeader('content-type', this.customHeaders()));
    };
    /**
